...
void initializeQuiz(Quiz *quiz) {
    QuizQuestion initial_questions[NUM_QUESTIONS] = {
        {"What is the root node in a tree?", 
         ...
         1, 1,
         "The root is the origin of the tree hierarchy, with no parent."},
         
        {"Which term describes a node with no children?", 
         {"Internal node", 
          "Parent node", 
          "Leaf node", 
          "Sibling node"}, 
         2, 1,
         "Leaf nodes are terminal (no children)."},

        {"If two nodes share the same parent, they are called:", 
         {"Ancestors", 
          "Siblings", 
          "Descendants", 
          "Subtrees"}, 
        ...
        {"The \"depth\" of a node refers to:", 
         {"Its number of children", 
          "The length of the longest path to a leaf", 
          "The number of edges from the root to the node", 
          "Its level in the tree"}, 
         2, 1,
         "Depth counts edges from the root (root depth = 0)."},
        ...
        {"What defines an \"internal node\"?", 
         {"Has at least one child", 
          ...
          "Has no siblings"}, 
         0, 1,
         "Internal nodes are non-leaves (≥1 child)."}
    };
...
void runQuiz(Quiz *quiz) {
    ...
    printf("\n=== TREE TERMINOLOGY QUIZ ===\n");
    printf("=== (Root, Leaves, Depth, Internal Nodes) ===\n\n");
    ...
    printf("\n=== QUIZ COMPLETE ===\n");
    printf("=== Thank you for testing your tree terminology knowledge! ===\n\n");
}
...
int main() {
    ...
    printf("Welcome to the Tree Terminology Quiz!\n");
    printf("This quiz covers roots, leaves, depth, and internal nodes.\n");
